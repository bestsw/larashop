...
<!--								<li><a href="{{url('/')}}">Home</a></li>
								...
								<li class="dropdown"><a href="#" class="active">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{url('blog_post')}}" class="active">Blog Single</a></li>
                                    </ul>
                                </li> 
...
<?php 
if(count($lrs_menu)){
   foreach($lrs_menu as $v){
      echo '<li><a href="'.url($v->menu_link).'">'.$v->menu_name.'</a></li>';
   }
}
?>
<!--                        @if(count($lrs_menu))
                            @foreach($lrs_menu as $v)
                              ...
                              <li><a href="{{url($v->menu_link)}}">{{$v->menu_name}}</a></li>
                            @endforeach
                        @endif-->
							</ul>
						</div>
